...
contract NOXRewardsV3 is Initializable, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardTransient {
    ...
    bytes32 private constant SIG_STAR = keccak256("STAR_CLAIM_V3");
    bytes32 private constant SIG_ISSUE = keccak256("ISSUE_CLAIM_V3");
    bytes32 private constant SIG_PR = keccak256("PR_CLAIM_V3");
